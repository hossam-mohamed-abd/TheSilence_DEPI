# web_scaping
## Purpose
Web scraping collectors for pharmacy, medicine, and reference data sources.
## What belongs here
...
## Folder structure
- `Gardenia/` — Child folder for a more specific responsibility within this area.
- `aldawaaegy/` — Child folder for a more specific responsibility within this area.
- `bloom code/` — Child folder for a more specific responsibility within this area.
- `fda_gov/` — Child folder for a more specific responsibility within this area.
## Developer usage
