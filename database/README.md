# database
## Purpose
Database schemas, migrations, seeds, and modeling documentation.
## What belongs here
...
## Folder structure
- `migrations/` — Child folder for a more specific responsibility within this area.
- `schema/` — Child folder for a more specific responsibility within this area.
- `seeds/` — Child folder for a more specific responsibility within this area.
## Developer usage
