# data
## Purpose
Data lake zones and local dataset documentation.
## What belongs here
...
## Folder structure
- `raw/` — Child folder for a more specific responsibility within this area.
- `staging/` — Child folder for a more specific responsibility within this area.
- `warehouse/` — Child folder for a more specific responsibility within this area.
## Developer usage
