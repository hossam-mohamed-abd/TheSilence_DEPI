...
## Major files
- `drug-event-0001-of-0034.json.zip` — Compressed raw source dataset shard.
- `drug-event-0002-of-0034.json.zip` — Compressed raw source dataset shard.
- `drug-event-0003-of-0034.json.zip` — Compressed raw source dataset shard.
- `drug-event-0004-of-0034.json.zip` — Compressed raw source dataset shard.
- `drug-event-0005-of-0034.json.zip` — Compressed raw source dataset shard.
- `drug-event-0006-of-0034.json.zip` — Compressed raw source dataset shard.
- `drug-event-0007-of-0034.json.zip` — Compressed raw source dataset shard.
- `drug-event-0008-of-0034.json.zip` — Compressed raw source dataset shard.
- `drug-event-0009-of-0034.json.zip` — Compressed raw source dataset shard.
- `drug-event-0010-of-0034.json.zip` — Compressed raw source dataset shard.
- `drug-event-0011-of-0034.json.zip` — Compressed raw source dataset shard.
- `drug-event-0012-of-0034.json.zip` — Compressed raw source dataset shard.
## Developer usage
