...
## Folder structure
- `q1/` — Child folder for a more specific responsibility within this area.
- `q2/` — Child folder for a more specific responsibility within this area.
- `q3/` — Child folder for a more specific responsibility within this area.
- `q4/` — Child folder for a more specific responsibility within this area.
## Developer usage
