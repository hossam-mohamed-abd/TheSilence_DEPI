...
## Purpose
Diagram source files and visual architecture references for this documentation domain.
## What belongs here
...
## Major files
- `authentication_authorization_flow.mmd` — Mermaid diagram source.
- `backend_request_lifecycle.mmd` — Mermaid diagram source.
## Developer usage
