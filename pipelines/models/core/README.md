...
## Major files
- `core_drug_categories.sql` — Project file related to this folder.
- `core_drugs.sql` — Project file related to this folder.
- `core_pharmacy_inventory.sql` — Project file related to this folder.
- `core_schema.yml` — Project file related to this folder.
## Developer usage
