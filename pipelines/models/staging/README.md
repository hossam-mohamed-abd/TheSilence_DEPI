...
## Major files
- `sources.yml` — Project file related to this folder.
- `staging_schema.yml` — Project file related to this folder.
- `stg_drug_categories.sql` — Project file related to this folder.
- `stg_drugs.sql` — Project file related to this folder.
- `stg_pharmacy_inventory.sql` — Project file related to this folder.
## Developer usage
