...
## Major files
- `column_normalizer.py` — Python script for scraping, cleaning, ETL, or utility processing.
- `push_to_postgres.py` — Python script for scraping, cleaning, ETL, or utility processing.
- `storage_ingestion.py` — Python script for scraping, cleaning, ETL, or utility processing.
## Developer usage
