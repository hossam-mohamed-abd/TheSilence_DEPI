...
- `availability_history.sql` — Project file related to this folder.
- `price_history.sql` — Project file related to this folder.
- `snapshots_schema.yml` — Project file related to this folder.
## Developer usage
