# pipelines/DataWarehouse_ETL
## Purpose
Data engineering pipeline code and workflow definitions.
## What belongs here
...
## Major files
- `config.py` — Python script for scraping, cleaning, ETL, or utility processing.
- `db.py` — Python script for scraping, cleaning, ETL, or utility processing.
- `dims.py` — Python script for scraping, cleaning, ETL, or utility processing.
- `facts.py` — Python script for scraping, cleaning, ETL, or utility processing.
- `main.py` — Python script for scraping, cleaning, ETL, or utility processing.
- `requirements.txt` — Project file related to this folder.
- `upsert.py` — Python script for scraping, cleaning, ETL, or utility processing.
## Developer usage
