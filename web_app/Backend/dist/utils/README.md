...
## Major files
- `bigintSerializer.js` — JavaScript runtime/build artifact or deployment entry point.
- `generateToken.js` — JavaScript runtime/build artifact or deployment entry point.
- `verifyToken.js` — JavaScript runtime/build artifact or deployment entry point.
## Developer usage
