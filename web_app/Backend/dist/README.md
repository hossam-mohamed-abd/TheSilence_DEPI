...
## Major files
- `app.js` — JavaScript runtime/build artifact or deployment entry point.
- `server.js` — JavaScript runtime/build artifact or deployment entry point.
- `test.js` — JavaScript runtime/build artifact or deployment entry point.
## Folder structure
