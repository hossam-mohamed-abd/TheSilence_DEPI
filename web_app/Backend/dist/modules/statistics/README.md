# web_app/Backend/dist/modules/statistics
## Purpose
...
## Major files
- `statistics.controller.js` — JavaScript runtime/build artifact or deployment entry point.
- `statistics.repository.js` — JavaScript runtime/build artifact or deployment entry point.
- `statistics.routes.js` — JavaScript runtime/build artifact or deployment entry point.
- `statistics.service.js` — JavaScript runtime/build artifact or deployment entry point.
## Developer usage
