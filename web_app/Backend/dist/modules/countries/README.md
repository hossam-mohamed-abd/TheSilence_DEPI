# web_app/Backend/dist/modules/countries
## Purpose
...
## Major files
- `country.controller.js` — JavaScript runtime/build artifact or deployment entry point.
- `country.repository.js` — JavaScript runtime/build artifact or deployment entry point.
- `country.routes.js` — JavaScript runtime/build artifact or deployment entry point.
- `country.service.js` — JavaScript runtime/build artifact or deployment entry point.
## Developer usage
