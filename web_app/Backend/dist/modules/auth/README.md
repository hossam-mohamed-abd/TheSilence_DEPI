# web_app/Backend/dist/modules/auth
## Purpose
...
## Major files
- `auth.controller.js` — JavaScript runtime/build artifact or deployment entry point.
- `auth.repository.js` — JavaScript runtime/build artifact or deployment entry point.
- `auth.routes.js` — JavaScript runtime/build artifact or deployment entry point.
- `auth.service.js` — JavaScript runtime/build artifact or deployment entry point.
- `auth.types.js` — JavaScript runtime/build artifact or deployment entry point.
- `auth.validation.js` — JavaScript runtime/build artifact or deployment entry point.
## Developer usage
