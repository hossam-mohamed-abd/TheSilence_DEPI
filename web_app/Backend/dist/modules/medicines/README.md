# web_app/Backend/dist/modules/medicines
## Purpose
...
## Major files
- `medicine.controller.js` — JavaScript runtime/build artifact or deployment entry point.
- `medicine.repository.js` — JavaScript runtime/build artifact or deployment entry point.
- `medicine.routes.js` — JavaScript runtime/build artifact or deployment entry point.
- `medicine.service.js` — JavaScript runtime/build artifact or deployment entry point.
## Developer usage
