# web_app/Backend/dist/modules/governorates
## Purpose
...
## Major files
- `governorate.controller.js` — JavaScript runtime/build artifact or deployment entry point.
- `governorate.repository.js` — JavaScript runtime/build artifact or deployment entry point.
- `governorate.routes.js` — JavaScript runtime/build artifact or deployment entry point.
- `governorate.service.js` — JavaScript runtime/build artifact or deployment entry point.
## Developer usage
