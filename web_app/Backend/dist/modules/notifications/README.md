# web_app/Backend/dist/modules/notifications
## Purpose
...
## Major files
- `notification.controller.js` — JavaScript runtime/build artifact or deployment entry point.
- `notification.repository.js` — JavaScript runtime/build artifact or deployment entry point.
- `notification.routes.js` — JavaScript runtime/build artifact or deployment entry point.
- `notification.service.js` — JavaScript runtime/build artifact or deployment entry point.
## Developer usage
