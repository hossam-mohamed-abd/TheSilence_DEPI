...
## Major files
- No committed files are currently present; this folder is reserved for future project assets.
## Folder structure
- `auth/` — Child folder for a more specific responsibility within this area.
- `categories/` — Child folder for a more specific responsibility within this area.
- `cities/` — Child folder for a more specific responsibility within this area.
- `countries/` — Child folder for a more specific responsibility within this area.
- `favorites/` — Child folder for a more specific responsibility within this area.
- `governorates/` — Child folder for a more specific responsibility within this area.
- `medicines/` — Child folder for a more specific responsibility within this area.
- `notifications/` — Child folder for a more specific responsibility within this area.
- `pharmacies/` — Child folder for a more specific responsibility within this area.
- `search/` — Child folder for a more specific responsibility within this area.
- `statistics/` — Child folder for a more specific responsibility within this area.
## Developer usage
