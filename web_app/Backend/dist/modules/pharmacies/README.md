# web_app/Backend/dist/modules/pharmacies
## Purpose
...
## Major files
- `pharmacy.controller.js` — JavaScript runtime/build artifact or deployment entry point.
- `pharmacy.repository.js` — JavaScript runtime/build artifact or deployment entry point.
- `pharmacy.routes.js` — JavaScript runtime/build artifact or deployment entry point.
- `pharmacy.service.js` — JavaScript runtime/build artifact or deployment entry point.
## Developer usage
