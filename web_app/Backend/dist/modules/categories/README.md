# web_app/Backend/dist/modules/categories
## Purpose
...
## Major files
- `category.controller.js` — JavaScript runtime/build artifact or deployment entry point.
- `category.repository.js` — JavaScript runtime/build artifact or deployment entry point.
- `category.routes.js` — JavaScript runtime/build artifact or deployment entry point.
- `category.service.js` — JavaScript runtime/build artifact or deployment entry point.
## Developer usage
