# web_app/Backend/dist/modules/favorites
## Purpose
...
## Major files
- `favorite.controller.js` — JavaScript runtime/build artifact or deployment entry point.
- `favorite.repository.js` — JavaScript runtime/build artifact or deployment entry point.
- `favorite.routes.js` — JavaScript runtime/build artifact or deployment entry point.
- `favorite.service.js` — JavaScript runtime/build artifact or deployment entry point.
## Developer usage
