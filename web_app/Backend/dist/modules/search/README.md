# web_app/Backend/dist/modules/search
## Purpose
...
## Major files
- `search.controller.js` — JavaScript runtime/build artifact or deployment entry point.
- `search.repository.js` — JavaScript runtime/build artifact or deployment entry point.
- `search.routes.js` — JavaScript runtime/build artifact or deployment entry point.
- `search.service.js` — JavaScript runtime/build artifact or deployment entry point.
## Developer usage
