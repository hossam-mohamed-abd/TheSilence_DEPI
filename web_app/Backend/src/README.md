...
- `server.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `test.ts` — TypeScript source file for application logic, models, routes, components, or services.
## Folder structure
- `config/` — Child folder for a more specific responsibility within this area.
- `middleware/` — Child folder for a more specific responsibility within this area.
- `modules/` — Child folder for a more specific responsibility within this area.
- `types/` — Child folder for a more specific responsibility within this area.
- `utils/` — Child folder for a more specific responsibility within this area.
## Developer usage
