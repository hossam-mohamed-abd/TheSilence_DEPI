# web_app/Backend/src/modules/notifications
## Purpose
...
## Major files
- `notification.controller.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `notification.repository.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `notification.routes.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `notification.service.ts` — TypeScript source file for application logic, models, routes, components, or services.
## Developer usage
