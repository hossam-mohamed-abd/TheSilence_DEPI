# web_app/Backend/src/modules/countries
## Purpose
...
## Major files
- `country.controller.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `country.repository.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `country.routes.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `country.service.ts` — TypeScript source file for application logic, models, routes, components, or services.
## Developer usage
