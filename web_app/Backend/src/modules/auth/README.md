# web_app/Backend/src/modules/auth
## Purpose
Feature module for one backend domain, keeping routes, controllers, services, and repositories close together.
## What belongs here
...
## Major files
- `auth.controller.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `auth.repository.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `auth.routes.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `auth.service.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `auth.types.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `auth.validation.ts` — TypeScript source file for application logic, models, routes, components, or services.
## Developer usage
