# web_app/Backend/src/modules/governorates
## Purpose
...
## Major files
- `governorate.controller.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `governorate.repository.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `governorate.routes.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `governorate.service.ts` — TypeScript source file for application logic, models, routes, components, or services.
## Developer usage
