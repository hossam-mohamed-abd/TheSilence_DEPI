# web_app/Backend/src/modules/favorites
## Purpose
...
## Major files
- `favorite.controller.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `favorite.repository.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `favorite.routes.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `favorite.service.ts` — TypeScript source file for application logic, models, routes, components, or services.
## Developer usage
