...
## Major files
- `bigintSerializer.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `generateToken.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `verifyToken.ts` — TypeScript source file for application logic, models, routes, components, or services.
## Developer usage
