# web_app/frontend/src/environments
## Purpose
...
## Major files
- `environment.prod.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `environment.ts` — TypeScript source file for application logic, models, routes, components, or services.
## Developer usage
