# web_app/frontend/src/app/features/auth/pages
## Purpose
...
## Folder structure
- `login/` — Child folder for a more specific responsibility within this area.
- `register/` — Child folder for a more specific responsibility within this area.
## Developer usage
