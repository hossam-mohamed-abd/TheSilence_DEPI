# web_app/frontend/src/app/components
## Purpose
...
## Folder structure
- `ai-assistan/` — Child folder for a more specific responsibility within this area.
- `home/` — Child folder for a more specific responsibility within this area.
- `pharmacy-details/` — Child folder for a more specific responsibility within this area.
- `shared/` — Child folder for a more specific responsibility within this area.
## Developer usage
