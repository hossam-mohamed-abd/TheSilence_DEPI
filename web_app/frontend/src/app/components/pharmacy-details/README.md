# web_app/frontend/src/app/components/pharmacy-details
## Purpose
...
## Major files
- `pharmacy-details.component.css` — Stylesheet for layout, theming, or component presentation.
- `pharmacy-details.component.html` — HTML template or static UI prototype.
- `pharmacy-details.component.ts` — TypeScript source file for application logic, models, routes, components, or services.
## Developer usage
