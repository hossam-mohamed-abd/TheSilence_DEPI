# web_app/frontend/src/app/components/home/components
## Purpose
Angular UI component area for a page, feature, or reusable visual element.
## What belongs here
...
## Folder structure
- `ai-features/` — Child folder for a more specific responsibility within this area.
- `categories/` — Child folder for a more specific responsibility within this area.
- `featured-medicines/` — Child folder for a more specific responsibility within this area.
- `featured-pharmacies/` — Child folder for a more specific responsibility within this area.
- `hero/` — Child folder for a more specific responsibility within this area.
- `how-it-works/` — Child folder for a more specific responsibility within this area.
- `popular-searches/` — Child folder for a more specific responsibility within this area.
