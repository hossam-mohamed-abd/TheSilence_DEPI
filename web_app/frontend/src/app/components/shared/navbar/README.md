# web_app/frontend/src/app/components/shared/navbar
## Purpose
...
## Major files
- `navbar.component.css` — Stylesheet for layout, theming, or component presentation.
- `navbar.component.html` — HTML template or static UI prototype.
- `navbar.component.ts` — TypeScript source file for application logic, models, routes, components, or services.
## Developer usage
