# web_app/frontend/src/app/components/shared
## Purpose
...
- `drug-card/` — Child folder for a more specific responsibility within this area.
- `footer/` — Child folder for a more specific responsibility within this area.
- `navbar/` — Child folder for a more specific responsibility within this area.
- `search-overlay/` — Child folder for a more specific responsibility within this area.
## Developer usage
