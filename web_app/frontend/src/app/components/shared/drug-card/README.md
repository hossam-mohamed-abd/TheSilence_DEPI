# web_app/frontend/src/app/components/shared/drug-card
## Purpose
...
## Major files
- `drug-card.component.css` — Stylesheet for layout, theming, or component presentation.
- `drug-card.component.html` — HTML template or static UI prototype.
- `drug-card.component.ts` — TypeScript source file for application logic, models, routes, components, or services.
## Developer usage
