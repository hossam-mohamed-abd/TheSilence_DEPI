...
## Folder structure
- `guards/` — Child folder for a more specific responsibility within this area.
- `models/` — Child folder for a more specific responsibility within this area.
- `services/` — Child folder for a more specific responsibility within this area.
## Developer usage
