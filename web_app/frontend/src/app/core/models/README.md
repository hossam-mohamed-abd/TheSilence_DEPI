# web_app/frontend/src/app/core/models
## Purpose
...
## Major files
- `category.model.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `drug.model.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `home-categories-response.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `login-request.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `notification.model.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `pharmacy.model.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `register-request.ts` — TypeScript source file for application logic, models, routes, components, or services.
- `user.ts` — TypeScript source file for application logic, models, routes, components, or services.
## Developer usage
